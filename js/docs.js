var docs = {
  'align-content': {
    ...
    'hy': '<p>Հավասարեցնում է flex-կոնտեյների շարքերը իր ներսում (գործում է միայն այն ժամանակ, երբ էլեմենտները դասավորված են մեկից ավել շարքերի մեջ):</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code> <code>stretch</code>',
    ...
    'it': '<p>Allinea le linee all\'interno di un contenitore flex se c\'è spazio extra lungo l\'asse verticale </p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code> <code>stretch</code>',
  ...
  'align-items': {
    ...
    'it': '<p>Allinea gli elementi flex lungo l\'asse verticale</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>baseline</code> <code>stretch</code>',
  ...
  'flex-wrap': {
    ...
    'it': '<p>Specifica se gli elementi flex vengono disposti forzatamente su una singola linea o se possono occupare più linee</p><code>nowrap</code> <code>wrap</code> <code>wrap-reverse</code>',
  ...
  'justify-content': {
    ...
    'it': '<p>Allinea gli elementi flex lungo l\'asse principale.</p><code>flex-start</code> <code>flex-end</code> <code>center</code> <code>space-between</code> <code>space-around</code>',
